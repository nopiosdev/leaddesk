...
const TaskListBottomTab = () => {
    ...
    return (
        <Tab.Navigator tabBar={props => <TaskBottomTabs {...props} />} initialRouteName={userDetails?.UserType == 'admin' ? 'TaskListScreen' : 'MyTask'} screenOptions={({ route }) => ({
            ...
            {userDetails?.UserType == 'admin' ?
                ...
                :
                <>
                    <Tab.Screen name="CreateByMe" component={CreateByMe} options={{ headerShown: false }} />
